...
<div class="container py-5 text-center">
    ...
    <form action=" {{ route('client.update', $client) }} " method="post">
       ...
       @endif
            ...
            <div class="mb-3">
                <label for="name" class="form-lebel">Nombre</label>
            ...
            <div class="mb-3">
                <label for="due" class="form-lebel">Saldo</label>
            ...
            <div class="mb-3">
                <label for="comments" class="form-lebel">Comentarios</label>
                <textarea name="comments" cols="30" rows="4"
                    class="form-control">{{old('comments') ?? @$client->comments }}</textarea>
            ...
            @else
              <button button type="submit" class="btn btn-info">Guardar Cliente</button>
            @endif
